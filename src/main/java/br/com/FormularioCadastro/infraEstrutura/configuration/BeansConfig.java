...
import br.com.FormularioCadastro.core.useCases.carroUseCase.DeleteCarroByIdUseCaseImpl;
import br.com.FormularioCadastro.core.useCases.carroUseCase.FindAllCarroUseCaseImpl;
...
public class BeansConfig {
    ...
    @Bean
    public FindAllCarrosUseCase findAllCarrosUseCase(CarroGateway carroGateway) {
        return new FindAllCarroUseCaseImpl(carroGateway);
    }

    @Bean
    public DeleteCarrosUseCase deleteCarrosUseCase(CarroGateway carroGateway) {
        return new DeleteCarroByIdUseCaseImpl(carroGateway);
    }
}
